...
<tr><td colspan="12" style="font:+5; color:#black;text-align:center" height="30">文化人才信息查询</td></tr>
  <tr>
    <td style="width:5%">
姓	名
    </td>
...
<script type="text/javascript">document.getElementById('dropPosttitleidList').value='${Posttitleid}';</script>    </td>
    ...
    <input type="button"  id="btnQuery"  style="background-image: url('img/xg9.jpg')" value="" onclick="search()" /></td>
  </tr>
...
<div id="divlist">
            ...
            <thead>
            <tr><td style="text-align:center" width="40px">
                操作                </td>
                <td style="text-align:center" width="50px">
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=select&OrderByItem=TalentID&OrderByItemDESC=${pageListOrderByItemDESCNo}">编号</a></td>
                <td style="text-align:center" >
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=select&OrderByItem=TalentName&OrderByItemDESC=${pageListOrderByItemDESCNo}">姓名</a></td>
                <td style="text-align:center" width="50px">
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=select&OrderByItem=Sex&OrderByItemDESC=${pageListOrderByItemDESCNo}">性别</a>                </td>
                <td style="text-align:center">
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=select&OrderByItem=NationID&OrderByItemDESC=${pageListOrderByItemDESCNo}">民族</a>                </td>
                <td style="text-align:center">
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=select&OrderByItem=NativePlace&OrderByItemDESC=${pageListOrderByItemDESCNo}">籍贯</a>                </td>
                <td style="text-align:center">
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=select&OrderByItem=EducationID&OrderByItemDESC=${pageListOrderByItemDESCNo}">学历</a>                </td>
                <td style="text-align:center">
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=select&OrderByItem=MajorID&OrderByItemDESC=${pageListOrderByItemDESCNo}">专业</a>                </td>
					<td>
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=select&OrderByItem=PostTitleID&OrderByItemDESC=${pageListOrderByItemDESCNo}">职称</a>
                </td>
                <td style="text-align:center">
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=select&OrderByItem=Skills&OrderByItemDESC=${pageListOrderByItemDESCNo}">专长</a>                </td>
              </tr>
            </thead>
		<s:iterator id="iteList" value="#request.TalentList">
            <tr><td>
                        <a href="${pageListUrl}&pagetype=Details&databasetalentid=${iteList.databasetalentid}">详情</a>   
				           </td>
				<td>
				&nbsp;${iteList.talentid}
				</td>
			...
			&nbsp;${iteList.objEducationInfoByEducationid.educationname}                </td>
                <td>
			&nbsp;${iteList.objMajorInfoByMajorid.majorname}              
			 </td>
                <td>
