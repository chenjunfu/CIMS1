...
人才成果编号
    ...
    <td>
<input name="talentachievementid" type="text" id="txtTalentachievementidEdit" value="${Talentachievementid}" title="人才成果编号" size="8" maxlength="8" />
    </td>
  </tr>
  <tr>
    <td>
成果
    ...
    <td>
<input name="achievement" type="text" id="txtAchievementEdit" value="${Achievement}" title="成果" size="60" maxlength="500" />
    </td>
  </tr>
  <tr>
    <td>
人才编号
    ...
    <td>
<input name="talentid" type="text" id="txtTalentidEdit" value="${Talentid}" title="人才编号" size="50" maxlength="50" />
    </td>
  </tr>
  <tr>
