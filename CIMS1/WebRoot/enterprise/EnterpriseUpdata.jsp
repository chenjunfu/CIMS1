...
<link rel="stylesheet" type="text/css" href="<%=basePath %>css/css.css" />
    ...
    <%--<tr>
	  ...
	  <tr><td colspan="12" style="font:+5; color:#black;text-align:center" height="30">文化企业信息变更</td></tr>
      <tr>
        <td> 企业名称 </td>
...
function search()
{
	var locationHref=window.location.pathname + "?pagetype=updata&state=1";
...
try{document.getElementById("dropRegionidList").value = "<%= com.colorwinglib.Requests.GetString(request,"regionids") %>";}catch (ex){}
    ...
    <div id="divlist">
            ...
            <tr>
              <td width="80px"> 操作 </td>
                <td width="80px">
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=updata&OrderByItem=EnterpriseID&OrderByItemDESC=${pageListOrderByItemDESCNo}">企业编号</a>
                </td>
                <td width="150px">
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=updata&OrderByItem=EnterpriseName&OrderByItemDESC=${pageListOrderByItemDESCNo}">企业名称</a>
                </td>
                <td width="150px">
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=updata&OrderByItem=BusinessTypeID&OrderByItemDESC=${pageListOrderByItemDESCNo}">行业类型</a>
                </td>
                ...
                <td width="80px">
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=updata&OrderByItem=ToalInvest&pagetype=updata&OrderByItemDESC=${pageListOrderByItemDESCNo}">总投资</a>
    
                </td>
                <td>
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=updata&OrderByItem=QualityID&OrderByItemDESC=${pageListOrderByItemDESCNo}">企业性质</a>
                </td>
                <td>
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=updata&OrderByItem=EmployNumber&OrderByItemDESC=${pageListOrderByItemDESCNo}">就业人数</a>
                </td>
                <td>
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=updata&OrderByItem=ProduceValue&OrderByItemDESC=${pageListOrderByItemDESCNo}">年产值</a>
                </td>
                <td>
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=updata&OrderByItem=Profit&OrderByItem=Profit&OrderByItemDESC=${pageListOrderByItemDESCNo}">利润</a>
                </td>
                <td width="100px">
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=updata&OrderByItem=SocialBenefit&OrderByItemDESC=${pageListOrderByItemDESCNo}">社会效益</a>
                </td>

                <td width="100px">
                    &nbsp;<a href="${pageListUrlOrderBy}&pagetype=updata&&OrderByItem=LoginTime&OrderByItemDESC=${pageListOrderByItemDESCNo}">登录时间</a>
                </td>
              </tr>
            </thead>
		<s:iterator id="iteList" value="#request.EnterpriseList">
            <tr>
              <td>
              <a href="${pageListUrl}&pagetype=gotoupdate&databaseenterpriseid=${iteList.databaseenterpriseid}">变更</a>

  <a onclick="if (confirm('你确定删除本条信息么？')) { window.location.href='${pageListUrl}&pagetype=delete&databaseenterpriseid=${iteList.databaseenterpriseid}'}" href="#">删除</a>
              </td>
                <td>
