...
产业编号
    ...
    <td>
    <label id="labIndustryidDetails">${Industryid}</label>
    </td>
  </tr>
  <tr>
    <td>
产业名称
    ...
    <td>
    <label id="labIndustrynameDetails">${Industryname}</label>
    </td>
  </tr>
  <tr>
    <td>
描述
    ...
    <td>
    <label id="labIndustrydescriptionDetails">${Industrydescription}</label>
    </td>
  </tr>
  <tr>
