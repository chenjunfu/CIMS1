...
工程类别编号
    ...
    <td>
<input name="projecttypeid" type="text" id="txtProjecttypeidEdit" value="${Projecttypeid}" title="工程类别编号" size="8" maxlength="8" />
    </td>
  </tr>
  <tr>
    <td>
工程类别名
    ...
    <td>
<input name="projecttypename" type="text" id="txtProjecttypenameEdit" value="${Projecttypename}" title="工程类别名" size="50" maxlength="50" />
    </td>
  </tr>
  <tr>
    <td>
