...
资金来源名
    ...
    <td>
<input name="foundsourcename" type="text" id="txtFoundsourcenameEdit" value="${Foundsourcename}" title="资金来源名" size="50" maxlength="50" />
    </td>
  </tr>
  <tr>
    <td>
...
<input name="description" type="text" id="txtDescriptionEdit" value="${Description}" title="描述" size="60" maxlength="500" />
  ...
  <tr>
    ...
    <input type="button" name="btnReturn" id="btnReturn" value="关闭" onclick="window.close();" />
    </td>
  </tr>
</table>
