...
<tr>
  <td colspan="11" style="font:+5; color:#black;text-align:center" height="30">产业项目信息查询</td></tr>
  <tr>
    <td>
项目名称
    </td>
...
$("#txtCreatetimeList").datepicker({changeMonth: true,changeYear: true}); //创建时间
    ...
    <td style="text-align: center;"><input type="button" name="button" id="btnQuery" style="background-image: url('../img/xg9.jpg')" value="" onClick="search()" />
    </td>
  </tr>
<script type="text/javascript">
function search()
...
<%
String projectnames=com.colorwinglib.Requests.GetString(request,"projectnames") ;
projectnames=new String(projectnames.getBytes("ISO-8859-1"),"utf-8");
%>
try{document.getElementById("txtProjectnameList").value = "<%=projectnames%>";}catch (ex){}
...
<div  >
      <table border="0" cellpadding="0" cellspacing="0" id="tbList" style="table-layout:fixed;word-break:break-all; word-wrap:normal;">
            ...
            <tr>
              ...
              <td  width="80px">
                  &nbsp;<a href="${pageListUrlOrderBy}&OrderByItem=ProjectID&OrderByItemDESC=${pageListOrderByItemDESCNo}">项目编号</a>
                </td>
                <td >
                    &nbsp;<a href="${pageListUrlOrderBy}&OrderByItem=ProjectName&OrderByItemDESC=${pageListOrderByItemDESCNo}">项目名称</a>
                </td>
                <td >
                    &nbsp;<a href="${pageListUrlOrderBy}&OrderByItem=RegionID&OrderByItemDESC=${pageListOrderByItemDESCNo}">所属区域</a>
                </td>
                <td width="150px">
                    &nbsp;<a href="${pageListUrlOrderBy}&OrderByItem=Address&OrderByItemDESC=${pageListOrderByItemDESCNo}">所在地址</a>
                </td>
                <td >
                    &nbsp;<a href="${pageListUrlOrderBy}&OrderByItem=DutyUnitID&OrderByItemDESC=${pageListOrderByItemDESCNo}">主管单位</a>
                </td>
                <td >
                    &nbsp;<a href="${pageListUrlOrderBy}&OrderByItem=DatabaseEnterpriseID&OrderByItemDESC=${pageListOrderByItemDESCNo}">经营单位</a>
                </td>
                <td width="150px">
                    &nbsp;<a href="${pageListUrlOrderBy}&OrderByItem=IndustryID&OrderByItemDESC=${pageListOrderByItemDESCNo}">产业类别</a>
                </td>
                <td >
                    &nbsp;<a href="${pageListUrlOrderBy}&OrderByItem=TotalInvest&OrderByItemDESC=${pageListOrderByItemDESCNo}">投入资金</a>
                </td>
                <td width="100px">
                    &nbsp;<a href="${pageListUrlOrderBy}&OrderByItem=CreateTime&OrderByItemDESC=${pageListOrderByItemDESCNo}">创建时间</a>
                </td>
               
                <td >
                    &nbsp;<a href="${pageListUrlOrderBy}&OrderByItem=DatabasePeopleID1&OrderByItemDESC=${pageListOrderByItemDESCNo}">填表人员</a>
                </td>
                <td >
                    &nbsp;<a href="${pageListUrlOrderBy}&OrderByItem=DatabasePeopleID2&OrderByItemDESC=${pageListOrderByItemDESCNo}">统计人员</a>
                </td>
              </tr>
            </thead>
		<s:iterator id="iteList" value="#request.IndustryProjectList">
            <tr>
              <td><a href="${pageListUrl}&pagetype=Details&databaseprojectid=${iteList.databaseprojectid}" >详情</a>
