...
部门编号
    ...
    <td>
    <label id="labSectoridDetails">${Sectorid}</label>
    </td>
  </tr>
  <tr>
    <td>
部门名称
    ...
    <td>
    <label id="labSectornameDetails">${Sectorname}</label>
    </td>
  </tr>
  <tr>
    <td>
...
是否删除
    ...
    <td>
    <label id="labIsDelDetails">${IsDellabel}</label>
    </td>
  </tr>
  <tr>
    <td>
排序
    ...
    <td>
    <label id="labSortsDetails">${Sorts}</label>
    </td>
  </tr>
  <tr>
