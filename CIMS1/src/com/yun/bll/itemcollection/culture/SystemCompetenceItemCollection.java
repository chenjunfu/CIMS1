...
/*======================================================================
   开发者:贾军磊
   创建日期:2012年12月03日 12:57:50
   功能说明: 表t_system_competence 权限表的SystemCompetenceItemCollection的类
   表说明:权限表
======================================================================*/

    /**
    * 表t_system_competence的SystemCompetenceItemCollection的类
	 */
public class SystemCompetenceItemCollection
{
	public SystemCompetenceItemCollection()
	{
		//
		// 
		//
