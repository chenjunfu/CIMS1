...
/*======================================================================
   开发者:贾军磊
   创建日期:2012年12月04日 09:33:46
   功能说明: 表t_talent 文化人才表的TalentItemCollection的类
   表说明:文化人才表
======================================================================*/

    /**
    * 表t_talent的TalentItemCollection的类
	 */
public class TalentItemCollection
{
	public TalentItemCollection()
	{
		//
		// 
		//
