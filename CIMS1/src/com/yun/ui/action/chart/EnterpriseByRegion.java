...
public class EnterpriseByRegion {
	JFreeChart chart;
	...
	{ 	
        ...
        chart = ChartFactory.createBarChart3D("按地区统计企业总量", // 图表标题  
                "", // 目录轴的显示标签  
                "个数", // 数值轴的显示标签  
                dataset, // 数据集  
        ...
        // 设置图显示标题  
        chart.setTitle(new TextTitle("按地区统计企业总量", new Font("黑体", Font.BOLD, 16)));  
	...
	{	
		...
		{
			dataset.addValue(EnterpriseProvider.GetListPagerByCreatetimeRegionid(createtime1, createtime2,region.getRegiondatabaseid()), region.getRegionname(), "");
		}
		return dataset;
	}
}
