...
public class EnterpriseByType {
	...
	{ 
        ...
        chart = ChartFactory.createBarChart3D("按行业统计企业总量", // 图表标题  
                "", // 目录轴的显示标签  
                "个数", // 数值轴的显示标签  
                dataset, // 数据集  
        ...
        // 设置图显示标题  
        chart.setTitle(new TextTitle("按行业统计企业总量", new Font("黑体", Font.BOLD, 16)));  
	...
	{	
		...
		ProfessionInfoCollection professions=ProfessionProvider.GetListBy();
		DefaultCategoryDataset dataset = new DefaultCategoryDataset();  
		for(ProfessionInfo profession:professions)
		{
			dataset.addValue(EnterpriseProvider.GetListPagerByBusinesstypeidCreatetime(profession.getBusinessdatabaseid(), createtime1, createtime2), profession.getBusinesstypename(), "");
		}
