...
/*     */ public class Age
/*     */ {
/*     */   private static final long serialVersionUID = 2011112115586003174L;
...
/*     */   {
/* 179 */     int Degreeid = Requests.GetInt(this.request, "degreeid", 0);
/*     */ 
/* 181 */     String pageListUrl = getpageListUrl();
/*     */ 
/* 183 */     DegreeInfo objDegreeInfo = DegreeProvider.GetDegreeInfoByDegreedatabaseid(Degreeid);
...
/*     */   {
/* 203 */     int Degreeid = Requests.GetInt(this.request, "degreeid", 0);
/*     */ 
/* 205 */     String pageListUrl = getpageListUrl();
/*     */ 
/* 207 */     DegreeInfo objDegreeInfo = DegreeProvider.GetDegreeInfoByDegreedatabaseid(Degreeid);
...
/* 233 */    
/*     */ 
/* 246 */     if (Requests.GetString(this.request, "degreename").length() == 0)
/*     */     {
/* 248 */       sbStr.append(String.format("%1$s.%2$s不能为空\n", new Object[] { Integer.valueOf(i), "学位名称" }));
/* 249 */       i++;
/*     */     }
/* 251 */     if (Validate.getLength(Requests.GetString(this.request, "degreename")) > 50)
/*     */     {
...
/*     */ 
/* 317 */     int Degreeid = Requests.GetInt(this.request, "degreeid", 0);
...
/*     */     }
/*     */ 
/* 331 */     DegreeInfo objDegreeInfo = DegreeProvider.GetDegreeInfoByDegreedatabaseid(Degreeid);
...
/*     */   {
/* 352 */     int Degreeid = Requests.GetInt(this.request, "degreeid", 0);
/*     */ 
/* 354 */     String pageListUrl = getpageListUrl();
/*     */ 
/* 358 */     DegreeProvider.DeleteByDegreedatabaseid(Degreeid);
/*     */ 
