...
/*     */ 
/*     */ public class TalentProfession
/*     */ {
/*     */   private static final long serialVersionUID = 2011112116025832218L;
...
/*  46 */     String pageListOrderByItem = Requests.GetString(this.request, "OrderByItem", "TalentProfessionID");
...
/*     */ 
/*  78 */     int Talentprofessionid = Requests.GetInt(this.request, "talentprofessionid", 0);
/*     */ 
/*  83 */     String pageName = "TalentProfession";
...
/*     */ 
/* 147 */     String OrderBy = "";
/* 148 */     String pageListOrderByItem = Requests.GetString(this.request, "OrderByItem", "TalentProfessionID");
...
/* 156 */     int pageAll = 0;
/* 157 */     pageAll = TalentProfessionProvider.GetListPagerBy();
/* 158 */     TalentProfessionInfoCollection TalentProfessionColl = TalentProfessionProvider.GetListPagerBy(OrderBy, pageIndex, this.pageSize);
/* 159 */     this.request.setAttribute("TalentProfessionList", TalentProfessionColl);
/*     */ 
...
/*     */   {
/* 179 */     int Talentprofessiondatabaseid = Requests.GetInt(this.request, "talentprofessiondatabaseid", 0);
/*     */ 
/* 181 */     String pageListUrl = getpageListUrl();
/*     */ 
/* 183 */     TalentProfessionInfo objTalentProfessionInfo = TalentProfessionProvider.GetTalentProfessionInfoByTalentprofessiondatabaseid(Talentprofessiondatabaseid);
/* 184 */     if (objTalentProfessionInfo != null)
/*     */     {	
				this.request.setAttribute("Talentprofessiondatabaseid", Talentprofessiondatabaseid);
/* 186 */       this.request.setAttribute("Talentprofessionid", Integer.valueOf(objTalentProfessionInfo.getTalentprofessionid()));
/* 187 */       this.request.setAttribute("Talentprofessionname", StringFormat.HtmlEncode(objTalentProfessionInfo.getTalentprofessionname()));
/*     */     }
/*     */     else
/*     */     {
...
/*     */   {
/* 203 */     int Talentprofessiondatabaseid = Requests.GetInt(this.request, "talentprofessiondatabaseid", 0);
/*     */ 		
/* 205 */     String pageListUrl = getpageListUrl();
/*     */ 		
/* 207 */     TalentProfessionInfo objTalentProfessionInfo = TalentProfessionProvider.GetTalentProfessionInfoByTalentprofessiondatabaseid(Talentprofessiondatabaseid);
/* 208 */     if (objTalentProfessionInfo != null)
/*     */     {	
				this.request.setAttribute("Talentprofessiondatabaseid", Talentprofessiondatabaseid);
/* 210 */       this.request.setAttribute("Talentprofessionid", Integer.valueOf(objTalentProfessionInfo.getTalentprofessionid()));
/* 211 */       this.request.setAttribute("Talentprofessionname", objTalentProfessionInfo.getTalentprofessionname());
/*     */     }
/*     */     else
/*     */     {
...
protected boolean ServerValidate()
{
    ...
    // [start] 行业类型名称
    valueMap = new java.util.HashMap<String,Object>();
    valueMap.put("label_name", "行业类型名称");
    if (com.colorwinglib.Requests.GetString(request, "talentprofessionname").length() == 0)
    {
        sbStr.append(String.format("%1$s.%2$s\n",i , com.yun.common.Message.GetMessage(com.yun.common.Message.E0000001, valueMap)));
        i = i + 1;
    }
    if (com.colorwinglib.Validate.getLength(com.colorwinglib.Requests.GetString(request, "talentprofessionname")) > 50)
    {
        valueMap.put("N", 50);
...
/*     */ 
/* 282 */     int Talentprofessionid = Requests.GetInt(this.request, "talentprofessionid", 0);
/* 283 */     String Talentprofessionname = Requests.GetString(this.request, "talentprofessionname", "");
/*     */ 
/* 286 */     if (!ServerValidate())
/*     */     {
/* 289 */       DrpInit();
/* 290 */       this.request.setAttribute("Talentprofessionid", Integer.valueOf(Talentprofessionid));
/* 291 */       this.request.setAttribute("Talentprofessionname", StringFormat.HtmlEncode(Talentprofessionname));
/* 292 */       return;
/*     */     }
/*     */ 
/* 295 */     TalentProfessionInfo objTalentProfessionInfo = new TalentProfessionInfo();
/* 296 */     objTalentProfessionInfo.setTalentprofessionid(Talentprofessionid);
/* 297 */     objTalentProfessionInfo.setTalentprofessionname(Talentprofessionname);
/*     */ 
/* 299 */     TalentProfessionProvider.Insert(objTalentProfessionInfo);
/*     */ 
/* 301 */     String js = Javascript.AlertAndRedirect(this.request, this.response, "添加成功", "?" + pageListUrl);
/* 302 */     if (Requests.GetInt(this.request, "isSaveAndNew") == 1)
/*     */     {
/* 304 */       js = Javascript.AlertAndRedirect(this.request, this.response, "添加成功", "?pagetype=gotoinsert&" + pageListUrl);
/*     */     }
/* 306 */     this.request.setAttribute("pageJavaScripStar", js);
/* 307 */     TalentProfessionProvider.setTalentProfessionStatic(null);
/*     */   }
/*     */ 
/*     */   protected void update()
/*     */   {
/* 315 */     String pageListUrl = getpageListUrl();
/*     */ 	  int Talentprofessiondatabaseid=Requests.GetInt(this.request, "talentprofessiondatabaseid",0);
/* 317 */     int Talentprofessionid = Requests.GetInt(this.request, "talentprofessionid", 0);
/* 318 */     String Talentprofessionname = Requests.GetString(this.request, "talentprofessionname", "");
/*     */ 
/* 321 */     if (!ServerValidate())
/*     */     {
/* 324 */       DrpInit();
				this.request.setAttribute("Talentprofessiondatabaseid", Talentprofessiondatabaseid);
/* 325 */       this.request.setAttribute("Talentprofessionid", Integer.valueOf(Talentprofessionid));
/* 326 */       this.request.setAttribute("Talentprofessionname", StringFormat.HtmlEncode(Talentprofessionname));
/* 327 */       return;
/*     */     }
/*     */    
/* 331 */     TalentProfessionInfo objTalentProfessionInfo = TalentProfessionProvider.GetTalentProfessionInfoByTalentprofessiondatabaseid(Talentprofessionid);
/* 332 */     objTalentProfessionInfo.setTalentprofessionid(Talentprofessionid);
/* 333 */     objTalentProfessionInfo.setTalentprofessionname(Talentprofessionname);
/*     */ 
/* 335 */     TalentProfessionProvider.UpdateByTalentprofessiondatabaseid(objTalentProfessionInfo);
/*     */ 
/* 337 */     String js = Javascript.AlertAndRedirect(this.request, this.response, "更新成功", "?" + pageListUrl);
/* 338 */     if (Requests.GetInt(this.request, "isSaveAndNew") == 1)
/*     */     {
/* 340 */       js = Javascript.AlertAndRedirect(this.request, this.response, "更新成功", "?pagetype=gotoinsert&" + pageListUrl);
/*     */     }
/* 342 */     this.request.setAttribute("pageJavaScripStar", js);
/* 343 */     TalentProfessionProvider.setTalentProfessionStatic(null);
/*     */   }
/*     */ 
/*     */   protected void delete()
/*     */   {
/* 352 */     int Talentprofessiondatabaseid = Requests.GetInt(this.request, "talentprofessiondatabaseid", 0);
/*     */ 
/* 354 */     String pageListUrl = getpageListUrl();
/*     */ 
/* 358 */     TalentProfessionProvider.DeleteByTalentprofessiondatabaseid(Talentprofessiondatabaseid);
/*     */ 
/* 360 */     TalentProfessionProvider.setTalentProfessionStatic(null);
 ...
 * Qualified Name:     com.yun.ui.action.dictionary.TalentProfession
